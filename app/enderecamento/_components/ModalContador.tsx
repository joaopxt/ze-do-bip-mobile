            ...
            >
              ...
              {produtoAtual && (
                <View style={styles.modalProductInfo}>
                  ...
                  <Text>Endereço: {produtoAtual.endereco}</Text>
                </View>
              )}
              ...
              <View style={styles.contadorContainer}>
                ...
                <Text
                  style={[
                    ...
                    produtoAtual &&
                      quantidadeContada === produtoAtual.quantidade &&
                      styles.contadorCompleto,
                  ]}
                >
                  {quantidadeContada}
                </Text>
                <Text style={styles.contadorInstrucao}>
                  {produtoAtual && produtoAtual.quantidade > 20
                    ? "Escaneie cada item ou digite a quantidade abaixo"
                    : `Escaneie exatamente ${produtoAtual?.quantidade} item(s) para liberar o botão`}
                </Text>
              </View>
                ...
                quantidadeContada > 0 && (
                  <View style={styles.quantidadeManualContainer}>
                    ...
                    <Text style={styles.quantidadeManualHint}>
                      Faltam: {produtoAtual.quantidade - quantidadeContada}{" "}
                      unidades
                    </Text>
                  </View>
                )}
              ...
              <View style={styles.modalButtons}>
                ...
                <Button
                  title="Confirmar"
                  onPress={onConfirmar}
                  disabled={quantidadeContada !== produtoAtual?.quantidade}
